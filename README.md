Chattie is a basic chat application that connects users into one room. The functionalities it currently has are: choosing a username, assigning a random robot icon, displaying the number of users in the room, displaying the names of active users, and a logout button.
